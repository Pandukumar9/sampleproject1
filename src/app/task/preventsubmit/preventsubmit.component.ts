...
@Component({
  selector: 'app-preventsubmit',
  templateUrl: './preventsubmit.component.html',
  styleUrls: ['./preventsubmit.component.css']
})
export class PreventsubmitComponent implements OnInit {
